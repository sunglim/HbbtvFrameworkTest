...
<ul id="menu" class="menu" style="left: 100px; top: 100px;">
  ...
  <li name="deviceID">Show deviceID</li>
  <li name="modelName">Show modelName</li>
  <li name="vendorName">Show vendorName</li>
  <li name="softwareVersion">Show softwareVersion</li>
  <li name="hardwareVersion">Show hardwareVersion</li>
  <li name="serialNumber">Show serialNumber</li>
