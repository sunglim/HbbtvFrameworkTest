...
<div class="txtdiv txtlg" style="left: 111px; top: 60px; width: 500px; height: 30px;">HbbTV App Framework</div>
...
<ul id="menu" class="menu" style="left: 100px; top: 100px;">
  ...
  <li name="lgappmanager" descr="Start applications, destroy application.">LG Application manager</li>
  ...
  <li name="links" descr="Test links">Test Links</li>
